...
void	NinjaTrap::ninjaShoebox(const ScavTrap &target) {
	...
	std::cout << _name << " Sees a Scav called " << target.getName() << " and burps" <<std::endl;
}

void	NinjaTrap::ninjaShoebox(const NinjaTrap &target) {

	std::cout << _name << " Sees another Ninja called " << target.getName() << " and spiderman-meme happens" <<std::endl;
}

void	NinjaTrap::ninjaShoebox(const FragTrap &target) {

	std::cout << _name << " Sees a Frag called " << target.getName() << " and publicly shames it" <<std::endl;
}
